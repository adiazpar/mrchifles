...
interface MemberRoleChangeBodyProps {
  member: TeamMember
}

/**
 * Body of the regular role-flip surface. Reached when direction is
 ...
 */
export function MemberRoleChangeBody({ member }: MemberRoleChangeBodyProps) {
  const t = useIntl()
