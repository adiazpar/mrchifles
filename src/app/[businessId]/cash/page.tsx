...
export default function CajaPage() {
  ...
  // Use extracted hooks
  const movementsHook = useCashMovements({ businessId })
  const sessionHook = useCashSession({ businessId, movements: movementsHook.movements })
          ...
          {/* Balance Hero with status */}
            ...
            <div className="caja-actions">
              ...
              <button
                type="button"
                onClick={() => {
                  setPendingHref(`/${businessId}/cash/history`)
                  router.push(`/${businessId}/cash/history`)
                }}
                className="caja-action-btn"
              >
